...
export function useMonthlyReport(params?: Record<string, unknown>) {
  return useQuery({
    ...
    queryFn: () => reportsApi.monthly(params).then(r => r.data.data),
  });
}
...
export function useYearlyReport(params?: Record<string, unknown>) {
  return useQuery({
    ...
    queryFn: () => reportsApi.yearly(params).then(r => r.data.data),
  });
}
...
export function useClientsReport(params?: Record<string, unknown>) {
  return useQuery({
    ...
    queryFn: () => reportsApi.clients(params).then(r => r.data.data),
  });
}
...
export function useSalariesReport(params?: Record<string, unknown>) {
  return useQuery({
    ...
    queryFn: () => reportsApi.salaries(params).then(r => r.data.data),
  });
}
...
export function useTreasuryReport(params?: Record<string, unknown>) {
  return useQuery({
    ...
    queryFn: () => reportsApi.treasury(params).then(r => r.data.data),
  });
}
...
export function usePartnersReport(params?: Record<string, unknown>) {
  return useQuery({
    ...
    queryFn: () => reportsApi.partners(params).then(r => r.data.data),
  });
}
